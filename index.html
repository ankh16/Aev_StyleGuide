...
<!-- This is an exxample of how to add text that won't be displayed in the readme (i.e., how to add comments), below is an example of centring a heading using span (you can render emojis or markdown inside it, note that the '#' is not included as 'h1' means the same thing) -->

<span align="center"> <h1 align="center">Independent Games</h1> </span>
<span align="center"> <h2 align="center">Aeviternity - Style Guide</h2> </span>

/** Placeholder Image */
<p align="center">
  <img src="https://i.pinimg.com/originals/df/9d/36/df9d365ff33f945b0859dff49ea37f20.jpg" />
</p>

[![Analytics](https://ga-beacon.appspot.com/UA-80567399-1/repo?useReferrer)](#)

## Spot for future Aev discord

Discord channel: ////.

## Linking To This Document // figure out how to replicate but with http://aev.style

Every section of this style guide is numbered for both easy reference and easy linking. You can link to any section directly by simply appending a hash tag and the section number to the end of http://ue4.style
